...
/* harmony import */ var _permissions_manager__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./permissions-manager */ "./resources/js/permissions-manager.js");
/* harmony import */ var _user_roles_manager__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./user-roles-manager */ "./resources/js/user-roles-manager.js");
...
new _permissions_manager__WEBPACK_IMPORTED_MODULE_1__.default({
  modal: modal
});
new _user_roles_manager__WEBPACK_IMPORTED_MODULE_2__.default({
  modal: modal
});
...
var Modal = /*#__PURE__*/function () {
  ...
  _createClass(Modal, [{
    ...
    value: function toggleModal() {
      ...
      this.body.toggleClass('modal-active'); // Trigger open and close events for others to see
...
/***/ "./resources/js/permissions-manager.js":
/*!*********************************************!*\
  !*** ./resources/js/permissions-manager.js ***!
  \*********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": () => (/* binding */ PermissionsManager)
/* harmony export */ });
function _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }
...
var PermissionsManager = /*#__PURE__*/function () {
  ...
  function PermissionsManager(options) {
    ...
    this.permissionsWrapper = $('#permissions_for_role').find('ul'); // Modal is added in app.js
  ...
  _createClass(PermissionsManager, [{
    key: "openForEdit",
    value: function openForEdit(row) {
      var entityId = row.attr('id');
      var entityName = row.attr('data-name');
    ...
    key: "callAjax",
    value: function callAjax(method, endpoint, data) {
      var self = this;
      var dataValue = data || this.editForm.serialize();
      ...
      $.ajax({
        ...
        error: function error(data) {
          self.errorMessage.html(data.responseJSON.error).removeClass('opacity-0').fadeOut(5000, function () {
    ...
    key: "retrievePermissionsForRole",
    value: function retrievePermissionsForRole(roleName, endpoint) {
      var self = this;
      $.ajax({
        url: this.baseUrl + endpoint,
        type: 'GET',
    ...
    key: "populateRolePermission",
    value: function populateRolePermission(response) {
      var self = this;
    ...
    key: "hasRolePermissionsStateChanged",
    value: function hasRolePermissionsStateChanged() {
      var self = this;
      this.currentState = {};
      this.editRolePermissions.each(function () {
      ...
      for (var key in this.rolePermissionSavedState) {
        if (this.rolePermissionSavedState.hasOwnProperty(key)) {
          var savedValue = this.rolePermissionSavedState[key];
...
/***/ "./resources/js/user-roles-manager.js":
/*!********************************************!*\
  !*** ./resources/js/user-roles-manager.js ***!
  \********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": () => (/* binding */ UserRolesManager)
/* harmony export */ });
function _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }
...
var UserRolesManager = /*#__PURE__*/function () {
  function UserRolesManager(options) {
    _classCallCheck(this, UserRolesManager);
  ...
  _createClass(UserRolesManager, [{
    ...
    key: "readRowEntities",
    value: function readRowEntities(row, entityType) {
      var self = this;
      var collection = row.find('li[data-type="' + entityType + '"]');
    ...
    key: "selectDialogCheckboxes",
    value: function selectDialogCheckboxes(entityType, entityName) {
      var self = this; // Reference the correct checkboxes for roles or permissions
    ...
    key: "disableAdminChangeForCurrentUser",
    value: function disableAdminChangeForCurrentUser(checkbox) {
      var currentUserId = $('input[name="current_user_id"]').val();
      var disabled = currentUserId === this.editUserId.val() ? 'disabled' : '';
      checkbox.prop('disabled', disabled);
    } // Call back end to see if this role has associated permissions

  }, {
    key: "retrievePermissionsOwnedByRole",
    value: function retrievePermissionsOwnedByRole(roleName, shouldShow) {
      var self = this;
    ...
    key: "togglePermissionsOwnedByRole",
    value: function togglePermissionsOwnedByRole(response, shouldShow) {
      var self = this;
      this.shouldShow = shouldShow;
    ...
    value: function addEventListeners() {
      ...
      this.editButtons.on('click', function (evt) {
        ...
        var row = $(this).parent().parent(); //Reset all elements in edit dialog

        self.resetModal();
        self.editUserName.html(name);
        self.editUserId.val(userId); // Find the lists of roles and permission in the row
      ...
      this.saveButton.on('click', function () {
        var dataValue = self.editForm.serialize();
        $.ajax({
          url: self.apiAction,
          type: 'POST',
          datatype: 'json',
